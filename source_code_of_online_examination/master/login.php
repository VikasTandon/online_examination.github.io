...
<body>
  ...
  <!-- Copyright -->
  <div class="text-center p-2" style="background-color: rgba(black);">
    © 2021 Copyright:
    <a class="text-dark" href="https://www.instagram.com/vikas_tandon_2000" target="_blank">PHP ONLINE EXAM</a>
  </div>
</body>
</html>
